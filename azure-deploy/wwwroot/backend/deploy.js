  ...
  try {
    ...
    try {
      ...
      if (jsonFiles.length === 0) {
        console.log("ℹ️ No local data files found to migrate");
        return;
      }
      ...
      if (error.code === 'ENOENT') {
        console.log("ℹ️ No local data directory found - skipping data migration");
        console.log("✅ Database is ready for fresh data from API calls");
      } else {
        throw error;
      }
    }
