...
export const LanguageProvider = ({ children }) => {
  ...
  const translateText = async (text, targetLanguage = currentLanguage) => {
    ...
    try {
      const response = await fetch('https://website-project-ai-production.up.railway.app/api/public-translation/translate', {
        method: 'POST',
...
export const CAILanguageSelector = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://website-project-ai-production.up.railway.app/api/public-translation/languages')
      .then(res => res.json())
